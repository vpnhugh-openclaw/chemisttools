...
export const siteConfig = {
  brand: {
    ...
    tagline: "Run your pharmacy like the best in the business.",
    domain: "tools.chemistcare.com.au",
    contactEmail: "hugh@burkeroadpharmacy.com.au",
    phone: "03 9882 5386",
    address: "1031 Burke Road, Camberwell VIC 3124",
    signInUrl: "https://tools.chemistcare.com.au/app",
    abn: "ABN 70 764 240 081",
    location: "Made in Sydney and Melbourne. Data hosted in Australia.",
  },
  hero: {
  ...
  pricing: {
    plans: [
      ...
      {
        id: "business-optimiser",
        name: "Business Optimiser",
        price: 199,
        tagline: "Everything in Core, plus compliance and QSPP readiness.",
        note: "AS85000:2024 lands from 1 October 2026. Business Optimiser gives you one register, one audit calendar, one readiness view.",
        includes: [
          "today",
          "operations",
          "knowledge",
      ...
      },
      {
        ...
        name: "Elite",
        price: 399,
        tagline: "The whole platform, plus on-site AI hardware.",
        note: "Everything in Business Optimiser, with PBS intelligence and Expiries included, plus rented on-site hardware for AI analysis and optimisation of your stock, pricing, and workflow. We install it, we manage it, you keep the insights.",
        includes: [
          "today",
          "operations",
          "knowledge",
...
export const MODULES: ModuleDef[] = [
  ...
  },
  {
    ...
    pricingNote: "Included in Business Optimiser. Recommended before October 2026.",
    faq: [
